namespace DiceRoll.Input.Parsing
{
    public abstract class ExternalTokenSolver
    {
        ...
        public abstract bool TrySolve(in Substring substring, ShuntingYardState state);
        
        private sealed class InertSolver : ExternalTokenSolver
        {
            public override bool TrySolve(in Substring substring, ShuntingYardState state) =>
                false;
        }
    }
}
